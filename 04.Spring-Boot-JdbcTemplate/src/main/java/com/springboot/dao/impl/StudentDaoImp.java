...
public class StudentDaoImp implements StudentDao {
	...
	public int add(Student student) {
		...
		String sql = "insert into test.student(sno,sname,ssex) values(:sno,:name,:sex)";
	...
	public int update(Student student) {
		String sql = "update test.student set sname = ?,ssex = ? where sno = ?";
	...
	public int deleteBysno(String sno) {
		String sql = "delete from test.student where sno = ?";
		Object[] args = { sno };
	...
	public Student queryStudentBySno(String sno) {
		String sql = "select * from test.student where sno = ?";
		Object[] args = { sno };
		int[] argTypes = { Types.VARCHAR };
